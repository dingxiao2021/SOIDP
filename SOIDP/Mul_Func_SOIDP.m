...
lay1_linklist_2=lay1_linklist^2-diag(diag(lay1_linklist^2)); % The second-order adjacency matrix of the first layer network 
lay1_linklist_2(lay1_linklist_2~=0)=1; % Turn the non-zero elements of the second-order adjacency matrix into 1 
lay1_linklist_2=lay1_linklist_2-lay1_linklist;% Remove first-order neighbors 
lay1_linklist_2(lay1_linklist_2==-1)=0;

lay2_linklist_2=lay2_linklist^2-diag(diag(lay2_linklist^2));%The second-order adjacency matrix of the second layer network 
...
for experi_times=1:1:repetitiontimes  %Train 10 times 
    ...
    for known_rate=theknown_rate  % p:0.05:0.05:0.5
        for testlabel=known_rate*100 
            ...
            lay1_2_rela_kno=lay1_2_rela_kno(1:kno_num,1:2); % Training set: The first column:node ID in layer 1; The second column:layer 2 node ID in layer 2
